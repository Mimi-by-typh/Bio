<script>
  ...
  const statusItems = [
    { label: 'Сейчас на повестке', value: 'эксперименты с UI' },
    { label: 'Слушаю', value: 'i hait it' },
    { label: 'Следующий дроп', value: 'анимация в доте' }
  ];

  // Typewriter effect
  let typedText = '';
  const fullText = 'Coder, I love DOTA';
  let showCursor = true;
  ...
  const links = [
    { id: 1, title: 'my tg channel', icon: 'telegram', url: 'https://t.me/Scliper', tooltip: 'Открыть Telegram', tooltipPos: 'top' },
    { id: 2, title: 'my github', icon: 'github', url: 'https://github.com/Mimi-by-typh', tooltip: 'Открыть Github', tooltipPos: 'top' }
  ...
  const trackName = 'i hait it';
  const artistName = 'never goodbye, overtonight';
  ...
  const contextMenuItems = [
    { icon: 'copy', label: 'Копировать ссылку', action: () => navigator.clipboard.writeText('https://Scliper.vercel.app') },
    { icon: 'share', label: 'Поделиться', action: () => navigator.share?.({ url: 'https://Scliper.vercel.app', title: 'Scliper' }) },
    { type: 'separator' },
    { icon: 'telegram', label: 'Telegram', action: () => window.open('https://t.me/Scliper', '_blank') },
    { icon: 'github', label: 'Github', action: () => window.open('https://github.com/Mimi-by-typh', '_blank') },
    { type: 'separator' },
  ...
  const spotlightItems = [
    { icon: 'person', title: 'О дизайнере', desc: 'Scliper — кодер, люблю доту 2', action: () => {} },
  { icon: 'telegram', title: 'Telegram', desc: 'Открыть ЛС в Telegram', action: () => window.open('https://t.me/Scliper', '_blank') },
  { icon: 'github', title: 'Github', desc: 'Открыть GitHub', action: () => window.open('https://github.com/Mimi-by-typh', '_blank') },
  ...
  onMount(() => {
    ...
    const removeMotionListener = (handler) => {
    ...
    addMotionListener(updateMotionPreference);
    ...
    return () => {
      removeMotionListener(updateMotionPreference);
    };
  });
  ...
  function handleZoom() {
    window.open('https://t.me/Scliper', '_blank');
  }
